...
export const getYoutubeLinkTag = (
  ...
  creator: string,
  thumbnail: string,
) => `<a href="${url}" target="_blank" style="text-decoration: none; color: inherit; margin-top: 10em;">
<div style="display: flex; align-items: center; width: 100%; max-width: 600px; border: 1px solid #ddd; border-radius: 10px; padding: 10px; gap: 15px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1); position: relative; cursor: pointer;">
  ...
  <div style="flex: 1; display: flex; flex-direction: column; position: relative;">
    ...
    <p style="font-size: 12px; color: #777; margin: 0;">크리에이터: <strong>${creator}</strong></p>
