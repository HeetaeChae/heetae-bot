...
export const BlogV1Prompts = {
  openingMent:
    '{text}\n위의 글에 대한 블로그 글을 쓸 것이다. 블로그 도입부 인삿말을 작성하라.\n1. 문체는 "~습니다."로 작성.\n2. 글자수는 100~150자로 작성.\n3. 문장이 끝날 때, 줄바꿈 처리를 위해 <br />태그를 넣어 줄바꿈 처리 필수.',
  descriptionRewriting:
    '{description}\n위의 글은 호텔을 소개하는 글이다. 이를 토대로 새롭게 글을 작성하라.\n1. 문체는 "~습니다."로 작성.\n2. 글자수는 150~200자로 작성.\n3. 문장이 끝날 때, 줄바꿈 처리를 위해 <br /><br />태그를 넣어 줄바꿈 처리 2회 필수.',
  aiReviewRewriting:
    '{aiReview}\n위의 글은 호텔 리뷰 글이다. 이를 토대로 새롭게 글을 작성하라. 1. 문체는 "~습니다."로 작성,\n글자수는 100자 이내로 작성.',
};
